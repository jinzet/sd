...
CDIBPal::CDIBPal(const int n, const unsigned char *red, const unsigned char *green, const unsigned char *blue)
{
  Create(n, red, green, blue);
}

CDIBPal::CDIBPal(const CDIBPal *pal)
{
	int count = ((CDIBPal *)pal)->GetEntryCount();
...
BOOL CDIBPal::Create(CMYJPG* pDIB)
{
...
BOOL CDIBPal::Create(const int n, const unsigned char *red, const unsigned char *green, const unsigned char *blue)
{
  if ((HPALETTE) *this)
    return FALSE;
...
int CDIBPal::GetPixel(const unsigned char red, const unsigned char green, const unsigned char blue)
{
  return ::GetNearestPaletteIndex((HPALETTE) (*this), RGB(red, green, blue));
}

BOOL CDIBPal::GetRGB(const int index, unsigned char *red, unsigned char *green, unsigned char *blue)
{
